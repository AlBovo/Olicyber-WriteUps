...
key = bytes.fromhex("DEADBEEFCAFEBABE")[::-1]
array = [0, 4, 6, 2, 5, 1, 3, 7]
mat = [
...
flag = bytes.fromhex("613D9554F622DB60BDF86C1FD986743D70F80816D9616555E88C161DA708640C7E1F2A289B3ABD4EF85DAE164114BD0A")
flag_blocks = [[e for e in flag[i:i+8]] for i in range(0, len(flag), 8)]

for block in flag_blocks:
    v3 = block
    v2 = [0 for _ in range(8)]
    for i in range(8):
        v2[i] = mat.index(v3[i])
    for i in range(8):
        v3[i] = v2[array[i]]
